...

{
  ...
  kustomizations: {
    ...
    sealedSecrets: renderKustomization(name='sealed-secrets', namespace='kube-system', cluster=config.cluster),
    itTools: renderKustomization(name='ittools', namespace='tools', cluster=config.cluster), 
  },
}
